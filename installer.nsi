...
Name "${APPNAME}"
Icon "GEstimator.ico"
outFile "GEstimator-win64-2-5-1.exe"
...
section "install"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${COMPANYNAME} ${APPNAME}" "DisplayIcon" "$\"$INSTDIR\GEstimator.ico$\""
